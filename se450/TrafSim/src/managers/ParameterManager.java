...
public class ParameterManager
{
	...
	private double		   generatedRoadLength	  = Math.random() * (getRoadSegmentLength().getMax() - getRoadSegmentLength().getMin()) + getRoadSegmentLength().getMin();
	private double		   generatedCarLength	  = Math.random() * (getCarLength().getMax() - getCarLength().getMin()) + getCarLength().getMin();
	...
	{
		return Math.round(simulationRunTime);
	}
	...
	public double getGeneratedRoadLength()
	{
		return generatedRoadLength;
	}
	...
	public double getGeneratedCarLength()
	{
		return generatedCarLength;
	}
